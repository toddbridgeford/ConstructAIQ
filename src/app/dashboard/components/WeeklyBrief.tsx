...
export function WeeklyBrief({ brief, generatedAt, source = "static" }: WeeklyBriefProps) {
  const weekOf = generatedAt ? new Date(generatedAt).toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"}) : new Date().toLocaleDateString("en-US",{month:"long",day:"numeric",year:"numeric"})
