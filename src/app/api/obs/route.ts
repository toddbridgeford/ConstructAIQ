...
// Last 25 months of baked-in seed data (Jan 2024 – Jan 2026)
...
// Generate ISO date strings ending at Jan 2026 going back n months
function seedDates(n: number): string[] {
  const dates: string[] = []
  for (let i = n - 1; i >= 0; i--) {
    let m = 0 - i   // 0-indexed month, anchored to Jan 2026
    let y = 2026
    while (m < 0) { m += 12; y-- }
