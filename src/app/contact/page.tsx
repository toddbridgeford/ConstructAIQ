...
const AMBER = "#f5a623", GREEN = "#30d158", RED = "#ff453a"
const BG0 = "#000", BG1 = "#0d0d0d", BG2 = "#1a1a1a"
const BD1 = "#2a2a2a", BD2 = "#383838"
const T1 = "#fff", T3 = "#a0a0ab", T4 = "#6e6e73"
    ...
    <div style={{ minHeight: "100vh", background: BG0, color: T1, fontFamily: SYS, paddingBottom: "env(safe-area-inset-bottom,20px)" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <div style={{ fontFamily: MONO, fontSize: 11, color: T4, letterSpacing: "0.1em" }}>CONTACT</div>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <Link href="/">
            <button style={{ background: "transparent", color: T3, fontFamily: MONO, fontSize: 13, padding: "8px 16px", borderRadius: 10, border: `1px solid ${BD1}`, minHeight: 44 }}>HOME</button>
          </Link>
          <Link href="/dashboard">
          ...
          <Link href="/pricing">
            <button style={{ background: "transparent", color: T3, fontFamily: MONO, fontSize: 13, padding: "8px 16px", borderRadius: 10, border: `1px solid ${BD1}`, minHeight: 44 }}>PRICING</button>
          </Link>
        </div>
      </nav>
