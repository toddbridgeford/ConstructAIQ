...
const FIELD_MAPS: Record<string, Record<string, string>> = {
  ...
  MIA: {
    permit_number: 'folio_number',
    permit_type:   'process_name',
    status:        'status',
    valuation:     'total_job_cost',
    address:       'site_address',
    zip_code:      'zip_code',
    applied_date:  'application_date',
  ...
  SFO: {
    ...
    address:       'street_number',
    zip_code:      'zipcode',
    applied_date:  'permit_creation_date',
    issued_date:   'issued_date',
    latitude:      'latitude',
    longitude:     'longitude',
  },
  ...
  BTR: {
    ...
    permit_type:   'permit_type',
    status:        'status',
    valuation:     'project_value',
    sqft:          'square_footage',
    address:       'full_address',
    zip_code:      'zip',
    applied_date:  'creation_date',
    issued_date:   'issued_date',
    latitude:      'latitude',
    longitude:     'longitude',
  },
  ...
  CAM: {
    ...
    address:       'address',
    zip_code:      'zip_code',
    applied_date:  'applicant_submit_date',
    issued_date:   'issue_date',
    latitude:      'latitude',
    longitude:     'longitude',
  },
  ...
  // BLDS-formatted portals (permits.partner.socrata.com)
  SRO: {
    permit_number: 'permitnum',
  ...
  // ── Expansion batch 3 ─────────────────────────────────────────────────────
  // BLDS PascalCase portals (San Diego County, Gainesville, Providence)
  SDC: {
    permit_number: 'PermitNum',
  ...
  // Howard County MD — mixed PascalCase/snake_case
  HWD: {
    permit_number: 'PermitNum',
    permit_type:   'permit_type',
    address:       'Address',
  ...
  // Montgomery County MD — all lowercase, non-standard names
  MGC: {
    permit_number: 'permitno',
    permit_type:   'applicationtype',
    status:        'status',
    valuation:     'declaredvaluation',
    sqft:          'buildingarea',
    address:       'stno',
    zip_code:      'zip',
    applied_date:  'addeddate',
    issued_date:   'issueddate',
    finaled_date:  'finaleddate',
  },
  // Detroit MI — archived dataset (May 2010 – Dec 2018)
  DET: {
    permit_number: 'permit_no',
    permit_type:   'permit_type',
