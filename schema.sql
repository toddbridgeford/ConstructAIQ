...
-- ---------------------------------------------------------------------------
-- Table: weekly_briefs
-- AI-generated weekly market intelligence briefs produced by Claude.
-- The cron job at /api/cron/brief writes one row per Monday; the route
-- returns the most recent row under 7 days old.
-- ---------------------------------------------------------------------------
...
COMMENT ON TABLE  weekly_briefs               IS 'AI-generated weekly construction market intelligence briefs.';
COMMENT ON COLUMN weekly_briefs.brief_text    IS 'Full text of the brief with HEADLINE SIGNAL, WHAT MOVED, and WATCH NEXT WEEK sections.';
COMMENT ON COLUMN weekly_briefs.generated_at  IS 'When the brief was generated; used for the 7-day cache TTL check.';
COMMENT ON COLUMN weekly_briefs.data_snapshot IS 'Snapshot of the Supabase observations used as prompt context.';
COMMENT ON COLUMN weekly_briefs.model         IS 'Claude model ID used to generate this brief.';
COMMENT ON COLUMN weekly_briefs.source        IS 'ai — generated by Claude; static — hardcoded fallback.';
